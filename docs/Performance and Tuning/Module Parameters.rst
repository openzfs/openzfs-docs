...
| Change            | Dynamic                                         |
+-------------------+-------------------------------------------------+
| Versions Affected | v0.6.5 to v2.3.x (renamed in v2.4.0)            |
+-------------------+-------------------------------------------------+
...
| Change                | Dynamic                                     |
+-----------------------+---------------------------------------------+
| Versions Affected     | v0.7.7 to v0.7.13 (renamed in v0.8.0)       |
+-----------------------+---------------------------------------------+
