...
#. Remove Fedora repo and install target distro repo, zfs repo::
    ...
    dnf remove -y fedora-release zfs-release
    dnf install -y https://repo.almalinux.org/almalinux/almalinux-release-latest-8.x86_64.rpm
    curl -O https://repo.almalinux.org/almalinux/RPM-GPG-KEY-AlmaLinux
    rpm --import RPM-GPG-KEY-AlmaLinux
    RHEL_ZFS_REPO=https://zfsonlinux.org/epel/zfs-release.el8_3.noarch.rpm
